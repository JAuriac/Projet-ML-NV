...
# param_grid_svc = {'kernel' : ['rbf']} #,'precomputed' ['linear','poly','rbf','sigmoid']
#                  #'C' : [0.5,1.0,1.5],
#                  #'degree' : [1,2,3,4,5]}#,
#                  #'gamma' : ['scale','auto']}
...
# # Save results
# np.savetxt("protein_test_svcStandard100.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcStandard100.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcStandard100.zip', 'w')
# zip_obj.write("protein_test_svcStandard100.predict")
# zip_obj.write("protein_valid_svcStandard100.predict")
#
# zip_obj.close()
#
# grid_svc.fit(X_standardNBis, y);
# print(grid_svc.best_params_)
# model_svc = grid_svc.best_estimator_
# score_svc = cross_val_score(model_svc, X, y)
# avg_score_svc = score_svc.mean()
# print(avg_score_svc)
# score_svcBis = cross_val_score(model_svc, X_standardNBis, y)
# avg_score_svcBis = score_svcBis.mean()
# print(avg_score_svcBis)
# # Predict on the test and validation data.
# y_test = grid_svc.predict(X_test_standardNBis)
# y_valid = grid_svc.predict(X_valid_standardNBis)
# # Save results
# np.savetxt("protein_test_svcStandard500.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcStandard500.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcStandard500.zip', 'w')
# zip_obj.write("protein_test_svcStandard500.predict")
# zip_obj.write("protein_valid_svcStandard500.predict")
#
# zip_obj.close()
# #
...
# # Save results
# np.savetxt("protein_test_svcMinMax2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcMinMax2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcMinMax2.zip', 'w')
# zip_obj.write("protein_test_svcMinMax2.predict")
# zip_obj.write("protein_valid_svcMinMax2.predict")
#
# zip_obj.close()
# #
...
# # Save results
# np.savetxt("protein_test_svcMaxAbs2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcMaxAbs2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcMaxAbs2.zip', 'w')
# zip_obj.write("protein_test_svcMaxAbs2.predict")
# zip_obj.write("protein_valid_svcMaxAbs2.predict")
#
# zip_obj.close()
# #
...
# # Save results
# np.savetxt("protein_test_svcRobust2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcRobust2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcRobust2.zip', 'w')
# zip_obj.write("protein_test_svcRobust2.predict")
# zip_obj.write("protein_valid_svcRobust2.predict")
#
# zip_obj.close()
#
...
# Save results
np.savetxt("protein_test_svcPowerYJ12.predict", y_test, fmt="%d")
np.savetxt("protein_valid_svcPowerYJ12.predict", y_valid, fmt="%d")

zip_obj = ZipFile('submission_svcPowerYJ12.zip', 'w')
zip_obj.write("protein_test_svcPowerYJ12.predict")
zip_obj.write("protein_valid_svcPowerYJ12.predict")

zip_obj.close()

# grid_svc.fit(X_powerYJBis, y);
# print(grid_svc.best_params_)
# model_svc = grid_svc.best_estimator_
# score_svc = cross_val_score(model_svc, X, y)
# avg_score_svc = score_svc.mean()
# print(avg_score_svc)
# score_svcBis = cross_val_score(model_svc, X_powerYJBis, y)
# avg_score_svcBis = score_svcBis.mean()
# print(avg_score_svcBis)
# # Predict on the test and validation data.
# y_test = grid_svc.predict(X_test_powerYJBis)
# y_valid = grid_svc.predict(X_valid_powerYJBis)
# # Save results
# np.savetxt("protein_test_svcPowerYJ500.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcPowerYJ500.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcPowerYJ500.zip', 'w')
# zip_obj.write("protein_test_svcPowerYJ500.predict")
# zip_obj.write("protein_valid_svcPowerYJ500.predict")
#
# zip_obj.close()
#
...
# # Save results
# np.savetxt("protein_test_svcQuantileTU2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcQuantileTU2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcQuantileTU2.zip', 'w')
# zip_obj.write("protein_test_svcQuantileTU2.predict")
# zip_obj.write("protein_valid_svcQuantileTU2.predict")
#
# zip_obj.close()
# #
...
# # Save results
# np.savetxt("protein_test_svcQuantileTN2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcQuantileTN2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcQuantileTN2.zip', 'w')
# zip_obj.write("protein_test_svcQuantileTN2.predict")
# zip_obj.write("protein_valid_svcQuantileTN2.predict")
#
# zip_obj.close()
# #
...
# # Save results
# np.savetxt("protein_test_svcNormalN2.predict", y_test, fmt="%d")
# np.savetxt("protein_valid_svcNormalN2.predict", y_valid, fmt="%d")
#
# zip_obj = ZipFile('submission_svcNormalN2.zip', 'w')
# zip_obj.write("protein_test_svcNormalN2.predict")
# zip_obj.write("protein_valid_svcNormalN2.predict")
#
# zip_obj.close()
# #
